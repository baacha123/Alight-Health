...
Usage:
    python commcloud_generate.py                    # Uses config defaults
    python commcloud_generate.py --excel data.xlsx  # Custom Excel file
    python commcloud_generate.py --limit 5          # Generate only 5 cases
    python commcloud_generate.py --skip-llm         # Skip LLM (simple keywords)
...
def main():
    ...
    if not excel_path.exists():
        ...
        print("Create it or run: python commcloud_generate.py --sample")
        sys.exit(1)
